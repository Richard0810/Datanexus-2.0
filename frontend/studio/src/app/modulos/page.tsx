...
export const initialModules = [
  ...
  },
  {
    ...
    icon: GraduationCap,
    imageSrc: "https://picsum.photos/seed/dn-mod2-library/600/400",
  ...
  },
  {
    ...
    icon: SearchIcon,
    imageSrc: "https://picsum.photos/seed/dn-mod3-search/600/400",
    aiHint: "web browser",
    difficulty: "Básico",
    color: "bg-purple-500"
  },
  {
    ...
    icon: PlayCircle,
    imageSrc: "https://picsum.photos/seed/dn-mod4-boolean/600/400",
  ...
  },
  {
    ...
    icon: BookMarked,
    imageSrc: "https://picsum.photos/seed/dn-mod6-manage/600/400",
  ...
  },
  {
    ...
    icon: CheckSquare,
    imageSrc: "https://picsum.photos/seed/dn-mod7-eval/600/400",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    imageSrc: "https://picsum.photos/seed/dn-mod8-ethics/600/400",
    aiHint: "ethics law",
    difficulty: "Avanzado",
    color: "bg-orange-500"
  },
  {
    ...
    icon: BookOpen,
    imageSrc: "https://picsum.photos/seed/dn-mod9-app/600/400",
