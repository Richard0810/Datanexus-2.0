...
- **Gestión de Datos (Admin)**: Implementación de botones para eliminar registros individuales y una función de limpieza masiva de registros no calificados para mantenimiento de la base de datos.
